...
class Moderation(Base):
    ...
    moderation_date: Mapped[datetime] = mapped_column(DateTime(timezone=True))
    ...
    advertisement_id: Mapped[int] = mapped_column(ForeignKey(column="advertisement.id", ondelete="CASCADE"),
                                                  unique=True)
